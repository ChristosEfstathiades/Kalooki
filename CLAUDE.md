...
Backend architecture (generated schema and models, Tuyau client generation, response shape, auth guards, import aliases) is documented in `apps/backend/CLAUDE.md`; the frontend stack and conventions in `apps/frontend/CLAUDE.md`. Each loads when working under that app.
